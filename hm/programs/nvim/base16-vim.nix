...
with config.colorscheme.colors;
{
  xdg.configFile."nvim/colors/base16-${config.colorscheme.slug}.vim".text = ''
    ...
    hi clear
    syntax reset
    let g:colors_name = "base16-${config.colorscheme.slug}"
    ...
    call <sid>hi("Folded",        s:gui03, s:gui01, s:cterm0E, s:cterm00, "Bold,Underline", "")
    call <sid>hi("IncSearch",     s:gui01, s:gui09, s:cterm0A, s:cterm01, "Bold,Underline", "")
    ...
    call <sid>hi("Search",        s:gui01, s:gui0A, s:cterm0A, s:cterm01,  "", "")
    call <sid>hi("Substitute",    s:gui01, s:gui0A, s:cterm0A, s:cterm01, "none", "")
    ...
    call <sid>hi("StatusLine",    s:gui04, s:gui02, s:cterm00, s:cterm0A, "none", "")
    ...
    call <sid>hi("SpellBad",     "", "", s:cterm05, s:cterm00, "Underline", s:gui08)
    call <sid>hi("SpellLocal",   "", "", s:cterm0F, s:cterm00, "Underline", s:gui0C)
    call <sid>hi("SpellCap",     "", "", s:cterm0E, s:cterm00, "Underline", s:gui0D)
    call <sid>hi("SpellRare",    "", "", s:cterm0F, s:cterm00, "Underline", s:gui0E)
